...
struct node* insert_left_check(struct node* pptr, int *taller)
{
    switch(pptr->balance)
    {
        case 0:
            pptr->balance=1;
            printf("case 0: of INSERT LEFT CHECK INVOKED\n");
            break;
        case -1:
            pptr->balance=0;
            *taller=FALSE;
            printf("case -1: of INSERT LEFT CHECK INVOKED\n");
            break;
        case 1:
...
struct node* leftbalance(struct node* pptr)
{
    ...
    if(aptr->balance==1)
    {
        aptr->balance=0;
        pptr->balance=0;
        printf("aptr->balance==-1: of INSERT LEFT balance INVOKED\n");
    ...
    else
    {
        ...
        {
            case -1:
            	printf("case -1: of INSERT LEFTbalance bbptr INVOKED\n");
                aptr->balance=1;
                pptr->balance=0;
                break;
            case 1:
                ...
                break;
            case 0:
            	printf("case 0: of INSERT LEFTbalance bbptr INVOKED\n");
                aptr->balance=0;
                pptr->balance=0;
                break;
        }
